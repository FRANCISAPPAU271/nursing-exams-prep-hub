          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="mt-1 text-sm text-emerald-800">
                All 7,000+ NCLEX, Ghana NMC and Midwifery questions, adaptive CAT tests, full timed mock exams, care plans and the complete video learning library are unlocked{planExpiresAt ? ` until ${new Date(planExpiresAt).toLocaleDateString()}` : ""}.
              </p>
            </div>
          </div>
        </section>
