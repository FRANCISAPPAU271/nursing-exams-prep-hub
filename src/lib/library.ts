...
export const LESSON_SEEDS: LessonSeed[] = [
  {
    ...
    description:
      "A guided tour of the dashboard: building study tasks, searching the 1,000-question bank, running practice quizzes, taking mock exams and reading your progress analytics.",
