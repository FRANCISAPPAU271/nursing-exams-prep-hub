...
import { PAST_PAPER_MEDICAL_3 } from "../lib/past-paper-medical-3";
import { PAST_PAPER_SURGICAL_1 } from "../lib/past-paper-surgical-1";
import { PAST_PAPER_SURGICAL_2 } from "../lib/past-paper-surgical-2";
...
async function main() {
  ...
  if (force || count < 3000) {
    ...
    for (const q of [...PAST_PAPER_MEDICAL, ...PAST_PAPER_MEDICAL_2, ...PAST_PAPER_MEDICAL_3, ...PAST_PAPER_SURGICAL_1, ...PAST_PAPER_SURGICAL_2]) {
      n++;
